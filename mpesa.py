import requests #this module is a third party library used for making HTTP request
import datetime #this module provides the classess for working with dates and times 
import base64 #this moduleprovides functions for working with base 64 binnary dat (asking characters)
...
# an API(Application Programing Interface)is a set of rules and protocols that allows ones software application to interact with another. In this case we are using mpesa API to interact with the mpesa server